...
```html
<link href="https://cdn.jsdelivr.net/npm/@nimiq/style@v0.6.2/nimiq-style.min.css" rel="stylesheet">
```

**Note:** To use icons, you need to host and serve
[the `nimiq-style.icons.svg` file](https://cdn.jsdelivr.net/npm/@nimiq/style@v0.6.2/nimiq-style.icons.svg)
